...
// // const OrderBookTable:React.FC<OrderBookTableContract > = ({ bidOrders, askOrders }) => {
// //   return (
// //     <div>
// //       <h3>Bid Orders</h3>
// //       <table>
...
// //         </thead>
// //         <tbody>
// //           {bidOrders?.map((order:any, index:any) => (
// //             <tr key={index}>
// //               <td>{order.price}</td>
// //               <td>{order.quantity}</td>
// //               <td>{order.total}</td>
...
// //         </thead>
// //         <tbody>
// //           {askOrders?.map((order:any, index:any) => (
// //             <tr key={index}>
// //               <td>{order.price}</td>
// //               <td>{order.quantity}</td>
// //               <td>{order.total}</td>
...
// interface OrderBookTableContract{

//   bidOrders:OrdersContract[];
//   askOrders:OrdersContract[];
// }